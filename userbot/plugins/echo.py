    ...
    if input_str:
        ...
        for echos in lsts:
            if echos.chat_type == "Personal":
                ...
                group_chats += (
                    f"☞ [{echos.user_name}](https://t.me/{echos.user_username}) in chat {echos.chat_name} of chat id `{echos.chat_id}`\n"
                    if echos.user_username
                    else f"☞ [{echos.user_name}](tg://user?id={echos.user_id}) in chat {echos.chat_name} of chat id `{echos.chat_id}`\n"
                )
